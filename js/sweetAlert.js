...
width: '80%',
    ...
    width: '80%',
        ...
        emigrar4.onclick = () => {
            Swal.fire({
                html: '<div class="sweet"> <h3 class="titleSweet">Expectativas Vs Realidad</h3><p class= "pSweet">¿Te pasó que, cuando no se logran ciertas cosas que habías proyectado, te desanimas pensando que no tenes la capacidad o que no sos bueno para eso?. Quizá lo que no frenaste a analizar es que muchas veces la vara está tan alta que las expectativas proyectadas ya son inalcanzables desde el inicio, dejándote en un fracaso seguro.Cuando para esto, la realidad te devuelve una imposibilidad, pero no por falta de capacidad, sino porque tenes expectativas más altas de lo que es posible para vos. “¡Lo mejor es enemigo de lo bueno!” decía mi abuela. No sea que por buscar lo mejor te pierdas de lo posible para este momento. A veces empezar por “lo bueno” es “lo mejor” que podés hacer.</p> </div>',
        width: '80%',
                backdrop:"true",
                confirmButtonText: 'Volver',
                confirmButtonColor: '#498563',
            ...
            emigrar5.onclick = () => {
                Swal.fire({
                    html: '<div class="sweet"> <h3 class="titleSweet">El choque cultural</h3> <p class= "pSweet">Cuando hablamos de choque cultural nos referimos al impacto que le genera a una persona pasar de una cultura familiar a una desconocida. Esto puede provocar ansiedad o sentimientos como incertidumbre y confusión. Al mismo tiempo, el esfuerzo que conlleva la adaptación - mucho más si hay que comprender otro idioma- requiere de un gasto de energía que puede terminar en agotamiento mental y físico. Si te sentís así, recordá que el cerebro es como una batería, todo ese procesamiento lo descarga y necesita momentos de descanso para no sobrepasarse. Bajar las exigencias es una buena forma de ayudar a tu mente. Cuando sientas que el choque cultural te abruma, recordá que no naciste en ese país, pretender no ser extranjero es una exigencia poco amable con vos.</p> </div>',
            width: '80%',
                    backdrop:"true",
                    confirmButtonText: 'Volver',
                    confirmButtonColor: '#498563',
                ...
                emigrar6.onclick = () => {
                    Swal.fire({
                        html: '<div class="sweet"> <h3 class="titleSweet">El duelo de los que se quedan</h3> <p class= "pSweet">Muchas miradas se posan en aquellos que se van, pero ¿qué pasa con los que se quedan?. Una vez una paciente me dijo: “Yo me sentía sola por estar fuera de mi país, hasta que hablé con un amigo que estaba allí y me dijo que él también se sentía sólo porque la mayoría se había ido. Nunca pensé que la gente que estaba en mi país podía sentirse igual de sola que yo, que me había ido. Ellos también sentían la pérdida.” El vacío que deja alguien querido - en lo cotidiano, en las fechas especiales - es difícil de procesar. No se trata de llenarlo, sino de convivir con él. Las dos partes sufren un cambio y será necesario un proceso amoroso y paciente para que los vínculos, puedan seguirse construyendo, a pesar y a través de la nueva realidad.</p> </div>',
                width: '80%',
                        backdrop:"true",
                        confirmButtonText: 'Volver',
                        confirmButtonColor: '#498563',
